...
class TestPageReading(unittest.TestCase):
    ...
    def test_sem1_class_401(self):
        ...
        with open('resources_json/out_sem1_401.json', 'r') as test_file:
            # test_file.write(page.to_json())
            json_string = test_file.read()
            self.assertEqual(json_string, page.to_json())
    ...
    def test_sem1_class_402(self):
        ...
        with open('resources_json/out_sem1_402.json', 'r') as test_file:
            # test_file.write(page.to_json())
            json_string = test_file.read()
            self.assertEqual(json_string, page.to_json())
    ...
    def test_sem1_class_405(self):
        ...
        with open('resources_json/out_sem1_405.json', 'r') as test_file:
            # test_file.write(page.to_json())
            json_string = test_file.read()
            self.assertEqual(json_string, page.to_json())
    ...
    def test_sem2_class_406(self):
        ...
        with open('resources_json/out_sem2_406.json', 'r') as test_file:
            # test_file.write(page.to_json())
            json_string = test_file.read()
            self.assertEqual(json_string, page.to_json())
    ...
    def test_sem2_class_321(self):
        ...
        with open('resources_json/out_sem2_321.json', 'r') as test_file:
            # test_file.write(page.to_json())
            json_string = test_file.read()
            self.assertEqual(json_string, page.to_json())
    ...
    def test_sem2_class_332(self):
        ...
        with open('resources_json/out_sem2_332.json', 'r') as test_file:
            # test_file.write(page.to_json())
            json_string = test_file.read()
            self.assertEqual(json_string, page.to_json())
    ...
    def test_sem2_class_505(self):
        ...
        with open('resources_json/out_sem2_505.json', 'r') as test_file:
            # test_file.write(page.to_json())
            json_string = test_file.read()
            self.assertEqual(json_string, page.to_json())
    ...
    def test_sem1_class_507(self):
        ...
        with open('resources_json/out_sem1_507.json', 'r') as test_file:
            # test_file.write(page.to_json())
            json_string = test_file.read()
            self.assertEqual(json_string, page.to_json())
    ...
    def test_sem2_class_507(self):
        ...
        with open('resources_json/out_sem2_507.json', 'r') as test_file:
            # test_file.write(page.to_json())
            json_string = test_file.read()
            self.assertEqual(json_string, page.to_json())
